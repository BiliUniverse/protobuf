        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string tname */ 4:
                    ...
                    break;
                case /* int64 up_id */ 5:
                    message.upId = reader.int64().toString();
                    break;
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 danmaku */ 7:
                    message.danmaku = reader.int64().toString();
                    break;
                case /* int32 ctime */ 8:
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 aid */ 3:
                    ...
                    break;
                case /* int64 play */ 4:
                    message.play = reader.int64().toString();
                    break;
                case /* int64 reply */ 5:
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* int64 source_from */ 1:
                    message.sourceFrom = reader.int64().toString();
                    break;
                case /* string scene */ 2:
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 jump_start_progress */ 3:
                    message.jumpStartProgress = reader.int64().toString();
                    break;
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 alpha_light */ 6:
                    message.alphaLight = reader.int64().toString();
                    break;
                case /* int64 alpha_night */ 7:
                    message.alphaNight = reader.int64().toString();
                    break;
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 notice_id */ 2:
                    message.noticeId = reader.int64().toString();
                    break;
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* int64 play_start_time */ 1:
                    message.playStartTime = reader.int64().toString();
                    break;
                case /* int64 play_end_time */ 2:
                    message.playEndTime = reader.int64().toString();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 select_bar_type */ 9:
                    message.selectBarType = reader.int64().toString();
                    break;
                case /* int64 new_search_exp_num */ 10:
                    message.newSearchExpNum = reader.int64().toString();
                    break;
...
class SearchByTypeRequest$Type extends MessageType {
    constructor() {
        super("bilibili.polymer.app.search.v1.SearchByTypeRequest", [
            ...
            { no: 4, name: "category_id", kind: "scalar", opt: true, T: 3 /*ScalarType.INT64*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* optional int64 category_id */ 4:
                    message.categoryId = reader.int64().toString();
                    break;
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 media_id */ 3:
                    message.mediaId = reader.int64().toString();
                    break;
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 game_base_id */ 7:
                    message.gameBaseId = reader.int64().toString();
                    break;
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 default_option_id */ 3:
                    message.defaultOptionId = reader.int64().toString();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 due_date */ 3:
                    message.dueDate = reader.int64().toString();
                    break;
