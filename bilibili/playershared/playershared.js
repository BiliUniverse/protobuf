...
class FragmentVideoInfo$Type extends MessageType {
    constructor() {
        super("bilibili.playershared.FragmentVideoInfo", [
            ...
            { no: 5, name: "timelength", kind: "scalar", T: 3 /*ScalarType.INT64*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 timelength */ 5:
                    message.timelength = reader.int64().toString();
                    break;
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string msg */ 3:
                    ...
                    break;
                case /* int64 mark */ 4:
                    message.mark = reader.int64().toString();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
...
class PlayArc$Type extends MessageType {
    constructor() {
        super("bilibili.playershared.PlayArc", [
            ...
            { no: 10, name: "watch_time_length", kind: "scalar", T: 3 /*ScalarType.INT64*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint64 aid */ 2:
                    ...
                    break;
                case /* uint64 cid */ 3:
                    message.cid = reader.uint64().toString();
                    break;
                ...
                case /* int64 watch_time_length */ 10:
                    message.watchTimeLength = reader.int64().toString();
                    break;
...
class PromptBar$Type extends MessageType {
    constructor() {
        super("bilibili.playershared.PromptBar", [
            ...
            { no: 13, name: "end_time", kind: "scalar", T: 3 /*ScalarType.INT64*/ }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint64 voice_balance */ 10:
                    message.voiceBalance = reader.uint64().toString();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
