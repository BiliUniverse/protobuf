...
class BuzzwordConfig$Type extends MessageType {
    constructor() {
        super("bilibili.community.service.dm.v1.BuzzwordConfig", [
            { no: 1, name: "keywords", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => BuzzwordShowConfig }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 buzzword_id */ 5:
                    message.buzzwordId = reader.int64().toString();
                    break;
...
class DanmakuAIFlag$Type extends MessageType {
    constructor() {
        super("bilibili.community.service.dm.v1.DanmakuAIFlag", [
            { no: 1, name: "dm_flags", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => DanmakuFlag }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
...
class DanmakuFlag$Type extends MessageType {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* int64 dmid */ 1:
                    message.dmid = reader.int64().toString();
                    break;
                case /* uint32 flag */ 2:
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.int32();
                    break;
                default: throw new globalThis.Error("unknown map entry field for bilibili.community.service.dm.v1.DanmuDefaultPlayerConfig.player_danmaku_ai_recommended_level_v2_map");
            }
        }
        map[key ?? 0] = val ?? 0;
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.int32();
                    break;
                default: throw new globalThis.Error("unknown map entry field for bilibili.community.service.dm.v1.DanmuPlayerConfig.player_danmaku_ai_recommended_level_v2_map");
            }
        }
        map[key ?? 0] = val ?? 0;
    }
...
class DanmuPlayerViewConfig$Type extends MessageType {
    constructor() {
        super("bilibili.community.service.dm.v1.DanmuPlayerViewConfig", [
            ...
            { no: 3, name: "danmuku_player_dynamic_config", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => DanmuPlayerDynamicConfig },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.int32();
                    break;
                default: throw new globalThis.Error("unknown map entry field for bilibili.community.service.dm.v1.DanmuWebPlayerConfig.ai_level_v2_map");
            }
        }
        map[key ?? 0] = val ?? 0;
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* int64 page_size */ 1:
                    message.pageSize = reader.int64().toString();
                    break;
                case /* int64 total */ 2:
...
class DmSegMobileReply$Type extends MessageType {
    constructor() {
        super("bilibili.community.service.dm.v1.DmSegMobileReply", [
            ...
            { no: 5, name: "colorfulSrc", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => DmColorful }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
...
class DmSegOttReply$Type extends MessageType {
    constructor() {
        super("bilibili.community.service.dm.v1.DmSegOttReply", [
            ...
            { no: 2, name: "elems", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => DanmakuElem }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
...
class DmViewReply$Type extends MessageType {
    constructor() {
        super("bilibili.community.service.dm.v1.DmViewReply", [
            ...
            { no: 16, name: "expressions", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Expressions },
            { no: 17, name: "post_panel", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => PostPanel },
            { no: 18, name: "activity_meta", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 19, name: "post_panel2", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => PostPanelV2 },
...
class DmWebViewReply$Type extends MessageType {
    constructor() {
        super("bilibili.community.service.dm.v1.DmWebViewReply", [
            ...
            { no: 9, name: "commandDms", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => CommandDm },
            ...
            { no: 12, name: "expressions", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Expressions },
            { no: 13, name: "post_panel", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => PostPanel },
...
class Expression$Type extends MessageType {
    constructor() {
        super("bilibili.community.service.dm.v1.Expression", [
            ...
            { no: 2, name: "url", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "period", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Period }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
...
class Expressions$Type extends MessageType {
    constructor() {
        super("bilibili.community.service.dm.v1.Expressions", [
            { no: 1, name: "data", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Expression }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 priority */ 3:
                    ...
                    break;
                case /* int64 biz_id */ 4:
                    message.bizId = reader.int64().toString();
                    break;
...
class TextInput$Type extends MessageType {
    constructor() {
        super("bilibili.community.service.dm.v1.TextInput", [
            ...
            { no: 6, name: "avatar", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Avatar },
...
class TextInputV2$Type extends MessageType {
    constructor() {
        super("bilibili.community.service.dm.v1.TextInputV2", [
            ...
            { no: 3, name: "render_type", kind: "enum", T: () => ["bilibili.community.service.dm.v1.RenderType", RenderType] },
            { no: 4, name: "placeholder_post", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 5, name: "avatar", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Avatar },
...
class VideoSubtitle$Type extends MessageType {
    constructor() {
        super("bilibili.community.service.dm.v1.VideoSubtitle", [
            ...
            { no: 3, name: "subtitles", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => SubtitleItem }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
