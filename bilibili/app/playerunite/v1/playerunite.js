        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* bilibili.playershared.ViewInfo view_info */ 9:
                    ...
                    break;
                case /* bilibili.playershared.FragmentVideo fragment_video */ 10:
...
class PlayViewUniteReq$Type extends MessageType {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string bvid */ 5:
                    ...
                    break;
                case /* string ad_extra */ 6:
                    message.adExtra = reader.string();
                    break;
                case /* bilibili.playershared.Fragment fragment */ 7:
                    message.fragment = Fragment.internalBinaryRead(reader, reader.uint32(), options, message.fragment);
                    break;
                case /* string from_scene */ 8:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* string ad_extra = 6; */
        if (message.adExtra !== "")
            writer.tag(6, WireType.LengthDelimited).string(message.adExtra);
        /* bilibili.playershared.Fragment fragment = 7; */
        if (message.fragment)
            Fragment.internalBinaryWrite(message.fragment, writer.tag(7, WireType.LengthDelimited).fork(), options).join();
        /* string from_scene = 8; */
        if (message.fromScene !== "")
            writer.tag(8, WireType.LengthDelimited).string(message.fromScene);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
