...
class PlayerArgs$Type extends MessageType {
    constructor() {
        super("bilibili.app.archive.middleware.v1.PlayerArgs", [
            { no: 1, name: "qn", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ },
            { no: 2, name: "fnver", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ },
            { no: 3, name: "fnval", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ },
            { no: 4, name: "force_host", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ },
            { no: 5, name: "voice_balance", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* int64 qn */ 1:
                    ...
                    break;
                case /* int64 fnver */ 2:
                    message.fnver = reader.int64().toNumber();
                    break;
                case /* int64 fnval */ 3:
                    message.fnval = reader.int64().toNumber();
                    break;
                case /* int64 force_host */ 4:
                    message.forceHost = reader.int64().toNumber();
                    break;
                case /* int64 voice_balance */ 5:
                    message.voiceBalance = reader.int64().toNumber();
                    break;
                default:
